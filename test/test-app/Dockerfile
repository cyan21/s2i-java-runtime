...
MAINTAINER Yann Chaysinh <yann.chaysinh@gmail.com>
...
LABEL io.k8s.description="My Spring Boot Application" \
    io.k8s.display-name="My App" \
    io.openshift.expose-services="8080:http" \
    io.openshift.tags="builder,springboot,test" \
    # this label tells s2i where to find its mandatory scripts
    # (run, assemble, save-artifacts)
    io.openshift.s2i.scripts-url="image:///usr/libexec/s2i"

# Install maven and clean the yum cache
